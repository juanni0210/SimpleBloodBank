...
/**
 * BloodBankTable shows all data from blood_bank table in simplebloodbank database.
...
public class BloodBankTableView extends HttpServlet{
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try( PrintWriter out = response.getWriter()){
            ...
            out.println( "<div class=\"row\" style=\"text-align: center; margin-top: 30px; margin-bottom:20px;\"><h5><b>Blood Banks</b></h5></div>" );
