...
/**
 * PersonTable shows all data from person table in simplebloodbank database.
 * @author Sophie Sun
 */
@WebServlet( name = "PersonTable", urlPatterns = { "/PersonTable" } )
public class PeopleTableView extends HttpServlet {
    ...
    protected void processRequest( HttpServletRequest request, HttpServletResponse response )
        ...
        try( PrintWriter out = response.getWriter() ) {
            ...
            out.println( "<html>" );
            out.println( "<head>" );
            out.println( "<title>PeopleViewNormal</title>" );
            ...
            out.println( "<div class=\"row\" style=\"text-align: center; margin-top: 30px; margin-bottom:20px;\"><h5><b>People</b></h5></div>" );
    ...
    protected void doPost( HttpServletRequest request, HttpServletResponse response )
        ...
        log( "POST" );
        PersonLogic logic = LogicFactory.getFor( "Person" );
        Person people = logic.updateEntity( request.getParameterMap() );
        logic.update( people );
        processRequest( request, response );
    }
